...
THEMES = {
    ...
    'lavender': {
        'bg_deep': '#faf8ff',
        'base': ('#ffffff', '#faf8ff', '#f5f0ff'),
        'accent': '#9333ea',
        'accent_rgb': '147,51,234',
        'secondary': '#c084fc',
        'secondary_rgb': '192,132,252',
        'light': True,
    },
    'noir': {
        'bg_deep': '#0a0a0a',
        'base': ('#0a0a0a', '#111111', '#141414'),
        'accent': '#d4af37',
        'accent_rgb': '212,175,55',
        'secondary': '#f5d061',
        'secondary_rgb': '245,208,97',
        'light': False,
    },
    'neon': {
        'bg_deep': '#0d0221',
        'base': ('#0d0221', '#140433', '#16053a'),
        'accent': '#ff00aa',
        'accent_rgb': '255,0,170',
        'secondary': '#00fff0',
        'secondary_rgb': '0,255,240',
        'light': False,
    },
}
