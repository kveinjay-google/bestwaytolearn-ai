...
const LEARNING_PATH = [
  ...
  },
  {
    ...
    title: '提示词工程入门',
    goto: [{ label: '知识库', href: '#knowledge' }, { label: '模拟操作', href: '#prompt-lab' }],
    ...
    tasks: [
      ...
      '在模拟操作体验 3 个实战模拟案例，同屏查看提示词与预置回复',
  ...
  },
  {
    ...
    title: '实战场景演练',
    goto: [{ label: '真实软件实操', href: '#hands-on' }, { label: '实战场景', href: '#practice' }, { label: '模拟操作', href: '#prompt-lab' }],
...
const PROMPT_CASES = [
  {
    ...
    task: '内容写作',
    role: '职场沟通顾问',
    context: '本周完成：1) 上线 BestWayToLearn.AI部署工具 v2，修复 Nginx 路由冲突；2) 客户演示 2 场，收集 5 条反馈；3) 输出模拟操作改版方案。卡点：服务器环境检测偶发超时。',
...
3. **模拟操作改版**：完成案例库 + 同屏模拟方案，降低新手上手门槛。
...
const QUIZ_DATA = [
  ...
  { q: '提示词迭代优化的正确流程是？', options: ['一次写完永不改', '初稿 → 看输出 → 补充约束/示例 → 再试', '越短一定越好', '删除所有格式要求'], answer: 1, explain: '提示词工程是实验科学；本站模拟操作即用于对比迭代。', topic: 'prompt-lab' },
...
const AI_MONETIZE_PROJECTS = [
  ...
  },
  {
    ...
    tools: ['Claude', 'ChatGPT', '模拟操作', 'Gamma'],
